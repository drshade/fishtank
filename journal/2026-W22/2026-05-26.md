...
- **Airstone to 24/7 for the trip** (per the 05-25 pre-trip checklist —
  "away >1 day → airstone load-bearing"). Still night-only as of today;
  flip the smart plug before departure. Heatwave reinforces it: canister is
  a single point of failure and nobody's watching, so the airstone is the
  independent O2 source.
